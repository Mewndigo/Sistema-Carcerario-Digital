...
public class RegistroAtividadeController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RegistroAtividadeResponseDTO> buscar(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RegistroAtividadeResponseDTO> alterar(@PathVariable UUID id,
